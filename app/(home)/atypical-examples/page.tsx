...
const AtypicalExamples: React.FC = () => {
  return (
    <main className="flex min-h-screen items-center justify-center flex-col">
      <h1 className="text-lg font-bold mt-4 text-green-dark">Accessible Atypical Examples</h1>
      ...
      <section className="flex flex-col items-center justify-center pb-4"> 
        <h2 className="text-lg font-bold mt-4 text-green-200 mb-6">Accessibility Examples</h2>
