...
const ColorContrastPage: React.FC = () => {
  return (
    <div>
      <main className="flex min-h-screen items-center justify-center flex-col">
        ...
        <section className="flex flex-wrap items-center justify-center gap-4 bg-green-dark w-full p-4">
          <PatternCard
            ...
            description={"This page intentionally contains links that are ONLY distinguished by color,including several cases with contrast < 3:1 vs surrounding text color"}
            link={"/color-contrast/surrounding-text"}
