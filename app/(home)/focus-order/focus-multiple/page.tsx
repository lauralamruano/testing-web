  ...
  return (
    <div className="p-4 border border-gray-300 rounded-lg shadow-md">
      ...
      <div className="flex flex-col gap-2">
        ...
        <button id="button1" className="p-2 bg-red-500 text-white rounded-md hover:bg-red-600">
          Otro botón 1
        </button>
        <button
          id="focusButton"
        ...
        <button id="button2" className="p-2 bg-red-500 text-white rounded-md hover:bg-red-600">
          Otro botón 2
        </button>
      </div>
    </div>
